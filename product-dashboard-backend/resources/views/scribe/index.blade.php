                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-DELETEapi-products--product_id-">DELETE api/products/{product_id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-products--product_id--rating">
                                <a href="#endpoints-POSTapi-products--product_id--rating">POST api/products/{product_id}/rating</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-products--product_id--rating">
                                <a href="#endpoints-DELETEapi-products--product_id--rating">DELETE api/products/{product_id}/rating</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;links&quot;: {
        ...
        &quot;prev&quot;: &quot;http://localhost:8000/api/products?page=15&quot;,
        &quot;next&quot;: null
    },
    &quot;meta&quot;: {
        &quot;current_page&quot;: 16,
        ...
        &quot;links&quot;: [
            {
                &quot;url&quot;: &quot;http://localhost:8000/api/products?page=15&quot;,
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>rating-desc</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>default</code></li> <li><code>latest</code></li> <li><code>oldest</code></li> <li><code>price-asc</code></li> <li><code>price-desc</code></li> <li><code>rating-desc</code></li> <li><code>title-asc</code></li></ul>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "price=1"\
    --form "image=@/tmp/php0a1p9gmvv8co81NeSci" </code></pre></div>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 0. Must not be greater than 99999999.99. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 4096 kilobytes. Example: <code>/tmp/php0a1p9gmvv8co81NeSci</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "description=Eius et animi quos velit et."\
    --form "price=1"\
    --form "image=@/tmp/phpf20ijf4l9grfa5Q4J1m" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 4096 kilobytes. Example: <code>/tmp/phpf20ijf4l9grfa5Q4J1m</code></p>
        </div>
        </form>
...
<p>The ID of the product. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-products--product_id--rating">POST api/products/{product_id}/rating</h2>
...
<span id="example-requests-POSTapi-products--product_id--rating">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/products/1/rating" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"rating\": 1
...
<span id="example-responses-POSTapi-products--product_id--rating">
</span>
<span id="execution-results-POSTapi-products--product_id--rating" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-products--product_id--rating"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-products--product_id--rating"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-products--product_id--rating" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-products--product_id--rating">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-products--product_id--rating" data-method="POST"
      data-path="api/products/{product_id}/rating"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-products--product_id--rating', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-products--product_id--rating"
                    onclick="tryItOut('POSTapi-products--product_id--rating');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-products--product_id--rating"
                    onclick="cancelTryOut('POSTapi-products--product_id--rating');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-products--product_id--rating"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/products/{product_id}/rating</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-products--product_id--rating"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-products--product_id--rating"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="product_id"                data-endpoint="POSTapi-products--product_id--rating"
               value="1"
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="rating"                data-endpoint="POSTapi-products--product_id--rating"
               value="1"
               data-component="body">
    <br>
<p>Must be at least 1. Must not be greater than 5. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-products--product_id--rating">DELETE api/products/{product_id}/rating</h2>
...
<span id="example-requests-DELETEapi-products--product_id--rating">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-products--product_id--rating">
</span>
<span id="execution-results-DELETEapi-products--product_id--rating" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-products--product_id--rating"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-products--product_id--rating"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-products--product_id--rating" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-products--product_id--rating">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-products--product_id--rating" data-method="DELETE"
      data-path="api/products/{product_id}/rating"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-products--product_id--rating', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-products--product_id--rating"
                    onclick="tryItOut('DELETEapi-products--product_id--rating');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-products--product_id--rating"
                    onclick="cancelTryOut('DELETEapi-products--product_id--rating');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-products--product_id--rating"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-products--product_id--rating"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-products--product_id--rating"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="product_id"                data-endpoint="DELETEapi-products--product_id--rating"
               value="1"
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>1</code></p>
